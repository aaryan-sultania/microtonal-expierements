...
major_transitions = (
    ...
    Transition(func_chords.major_chord_V, (0, 1, 2), func_chords.major_chord_I, (0,), None, 0),
    Transition(func_chords.major_chord_V, (0, 1, 2), func_chords.major_chord_vi, (0, 1, 2), None, 20),

    Transition(func_chords.major_chord_IV, (0, 1, 2), func_chords.major_chord_I, (0,), None, 0),
    Transition(func_chords.major_chord_IV, (0, 1, 2), func_chords.major_chord_V, (0, 1, 2), None, 0),
    Transition(func_chords.major_chord_IV, (0,), func_chords.major_chord_iv, (0,), None, 60),
    Transition(func_chords.major_chord_IV, (1,), func_chords.major_chord_iv, (1,), None, 60),
    Transition(func_chords.major_chord_IV, (2,), func_chords.major_chord_iv, (2,), None, 60),

    Transition(func_chords.major_chord_iv, (0, 1, 2), func_chords.major_chord_I, (0,), None, 0),

    Transition(func_chords.major_chord_ii, (0, 1, 2), func_chords.major_chord_V, (0, 1, 2), None, 0),
    Transition(func_chords.major_chord_bII, (0, 1, 2), func_chords.major_chord_V, (0, 1, 2), None, 0),

    Transition(func_chords.major_chord_itaug6, (0,), func_chords.major_chord_I, (2,), None, 20),
    Transition(func_chords.major_chord_itaug6, (0,), func_chords.major_chord_V, (0,), None, 20),
    Transition(func_chords.major_chord_fraug6, (0,), func_chords.major_chord_I, (2,), None, 20),
    Transition(func_chords.major_chord_fraug6, (0,), func_chords.major_chord_V, (0,), None, 20),
    Transition(func_chords.major_chord_graug6, (0,), func_chords.major_chord_I, (2,), None, 20),
    Transition(func_chords.major_chord_graug6, (0,), func_chords.major_chord_V, (0,), None, 20),
